...
class CarState(object):
    ...
    def displayState(self):
        ...
        print('CurLapTime: ', self.curLapTime)
        print('Damage: ', self.damage)
        print('DistFromStart: ', self.distFromStart)
        print('DistRaced: ', self.distRaced)
        print('Focus: ', self.focus)
        print('Fuel: ', self.fuel)
        print('Gear: ', self.gear)
        print('LastLapTime: ', self.lastLapTime)
        print('Opponents: ', self.opponents)
        print('RacePos: ', self.racePos)
        print('Rpm: ', self.rpm)
        print('SpeedX: ', self.speedX)
        print('SpeedY: ', self.speedY)
        print('SpeedZ: ', self.speedZ)
        print('Track: ', self.track)
        print('TrackPos: ', self.trackPos)
        print('WheelSpinVel: ', self.wheelSpinVel)
        print('Z: ', self.z)
